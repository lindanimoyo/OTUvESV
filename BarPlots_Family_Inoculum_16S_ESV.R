...
#run function
bacpercentID_zotu <- percentidentified(zotu_abundance_taxa2)

bacpercentID_zotu

write.csv(bacpercentID_zotu, "Figures/otuvzotu_taxonomy/bacpercent_ID_zotu_rarefied.csv")
##########################################################################################
...
phylum_abundance3_zotu$Phylum <- ldply(str_split(string=phylum_abundance3_zotu$Kingdom_Phylum, pattern=";p__"), rbind)[,2] # Divide a column using "_".
...
write.csv(phyla_sorted_zotu, "Figures/otuvzotu_taxonomy/16S_Inoculum_phylasorted_zotu_rarefied.csv")
fam_barplot1_zotu
ggsave(fam_barplot1_zotu,filename=paste("Figures/otuvzotu_taxonomy/fambarplot_inoculum_16S_zotu_rarefied.pdf"), width=7, height=4.5)
