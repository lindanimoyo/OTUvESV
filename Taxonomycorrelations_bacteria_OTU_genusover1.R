...
#read in dataframes
otu_abundance_taxa<- read.csv("data/16S_usearch10/OTU_inoculum_bacteria.csv", row.names=1)
...
length(phylum_over1_vector) #34 genera

write.csv(phylum_over1, "Figures/otuvzotu_taxonomy/bacteria_OTU_genusover1%relativeabundance.csv")
